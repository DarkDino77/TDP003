#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright (C) 2011, IDA, LinkÃ¶ping University
# Copyright (C) 2011, TorbjÃ¶rn LÃ¶nnemark <tobbez@ryara.net>
...
class DataTest(unittest.TestCase):
    ...
    def test_search(self):
        ...
        # Search for 'okÃ¤nt' in specified_used search fields, provide empty technique list
        # Ensure correct number of results
        res = data.search(self.loaded_data,
                                     techniques=[],
                                     search="okÃ¤nt",
        ...
        # Ensure 0 results
        res = data.search(self.loaded_data, search="okÃ¤nt", search_fields=[])
